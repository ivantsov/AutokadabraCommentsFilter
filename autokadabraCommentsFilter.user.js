	...
	var Filter = {
        getAvgRating: function(){
            ...
            $(".comment").each(function(){
                rating = parseInt($(this).find(".count").html()) || 0;
        ...
        run: function(){
            ...
            $(".comments .comment").each(function(){
                ...
                else if($(this).hasClass("cool-comment") && $(this).find(".cool-comment").length == 0 && $(this).find(".reply .show-reply").length == 0 && $(this).find(".reply_link").length > 1) $(this).find(".reply_link").eq(0).append("<a class='show-reply show-reply-hide' style='float: right' href='javascript:void(0)'>Показать ответы</a>");
            });
        },
